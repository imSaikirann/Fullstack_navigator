    ...
    <VStack className="mainhome">
      ...
      <Center h={{ base: '100%', md: 'auto' }}>
        <Card
          ...
          borderRadius="14px"
        >
          <VStack gap={{ base: '1rem', md: '2rem' }}>
            <Stack gap="1rem">
              <CardBody>
                <Heading size="lg" color="#1A191E">
                  Frontend
                </Heading>
        ...
        <Stack>
          <CardBody>
            <Flex flexDirection="column" gap="2rem">
              <Box>
                <Heading fontSize="2rem" color="#1A191E">
                  Developer Tools
                </Heading>
                ...
                <Text fontFamily="Raleway" fontSize="1.2rem" color="#212326">
                  Ready to Dive In?
                </Text>
              </Box>
              <Box>
